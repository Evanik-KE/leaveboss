                ...
                <form method="POST" name="signin">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                            ...
                            <input type="password" id="password" name="password" onpaste="return false;"  autocomplete="off" required>
                            <i class="ti-lock"></i>
                            <div class="text-danger"></div>
                        </div>
                        ...
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted">Are you an admin? Click<a href="admin/index.php">Admin</a></p>
                        </div>
                    </div>
                </form>
            </div>

    ...
    <head>
        ...
        <!-- <script type="text/javascript">
            function valid() {
                if (document.addemp.password.value != document.addemp.confirmpassword.value) {
                    $msg = "New Password and Confirm Password Field do not match  !!";
        ...
        <script>
            function validateForm() {
                var firstName = document.addemp.firstName.value.trim();
                var lastName = document.addemp.lastName.value.trim();
                var password = document.addemp.password.value.trim();
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mt-5">
                                    ...
                                    <div class="card">
                                        ...
                                        <form name="addemp" method="POST" onsubmit="return validateForm()">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="county" type="text" autocomplete="off" required id="example-text-input">
                                                </div>
                                                ...
                                                <button class="btn btn-primary" name="add" id="update" type="submit" onclick="return validateForm();">PROCEED</button>

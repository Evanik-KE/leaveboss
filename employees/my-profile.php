<?php
    ...
    $sql="update tblemployees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,County=:county,Phonenumber=:mobileno where EmailId=:eid";
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="county" type="text"  value="<?php echo htmlentities($result->County);?>" autocomplete="off" required id="example-text-input">
                                        </div>

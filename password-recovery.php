...
<head>
    ...
    <title>LeaveBoss - Password Recovery</title>
                ...
                foreach ($results as $result) {
					...
					<div class="login-form-body">
                        ...
                        <div class="form-gp">
                            ...
                            <input type="password" id="exampleInputEmail1" name="newpassword" onpaste="return false;"  required autocomplete="off">
                            <i class="ti-key"></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputPassword1">Confirm Password</label>
                            <input type="password" id="exampleInputPassword1" name="confirmpassword" onpaste="return false;"  required autocomplete="off">
                            <i class="ti-key"></i>
                            <div class="text-danger"></div>
                        </div>
